import type { ApiEventItem } from '../mockTypes';
...
const API_EVENTS_DATA: ApiEventItem[] = [
    {
        id: 1,
        title: "Bidathon",
    ...
    },
    {
        ...
        shortDescription: "Analyze real-world industrial challenges using Bureau of Indian Standards guidelines and present structured solutions.",
        date: "April 12, 2026",
        time: "TBA",
        location: "Chemical Engineering Department",
        category: "COMPETITION",
        ...
        details: {
            ...
            organizer: "TBA",
            tags: ["BIS", "Case Study", "Industrial Standards", "Compliance", "₹10k Prize"],
            website: "https://forms.gle/U9cuFAVcMVxGoQDV8",
        },
    }
];

export default API_EVENTS_DATA;
